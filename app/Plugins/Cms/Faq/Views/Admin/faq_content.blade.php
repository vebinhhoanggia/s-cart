            ...
            <div class="card-header with-border">
                ...
                <div class="card-tools">
                    <div class="btn-group float-right mr-5">
                        <a href="{{ sc_route_admin('admin_faq_content.index') }}" class="btn  btn-flat btn-default" title="List"><i
            ...
            <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"
                ...
                <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                        <div
                            class="form-group  row {{ $errors->has('descriptions.'.$code.'.question') ? ' text-red' : '' }}">
                            <label for="{{ $code }}__question"
                                class="col-sm-2 col-form-label">{{ trans($pathPlugin.'::Content.question') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                    </div>
                                    <input type="text" id="{{ $code }}__question" name="descriptions[{{ $code }}][question]"
                                        value="{{ old()? old('descriptions.'.$code.'.question'):($descriptions[$code]['question']??'') }}"
                                        class="form-control {{ $code.'__question' }}" placeholder="" />
                                </div>
                                @if ($errors->has('descriptions.'.$code.'.question'))
                                <span class="form-text">
                                    <i class="fa fa-info-circle"></i> {{ $errors->first('descriptions.'.$code.'.question') }}
                                </span>
                                @else
                                <span class="form-text">
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__keyword"
                                class="col-sm-2 col-form-label">{{ trans($pathPlugin.'::Content.keyword') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div
                            ...
                            <label for="{{ $code }}__description"
                                class="col-sm-2 col-form-label">{{ trans($pathPlugin.'::Content.description') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                        ...
                        <div
                            class="form-group row {{ $errors->has('descriptions.'.$code.'.answer') ? ' text-red' : '' }}">
                            <label for="{{ $code }}__answer"
                                class="col-sm-2 col-form-label">{{ trans($pathPlugin.'::Content.answer') }}</label>
                            <div class="col-sm-8">
                                <textarea id="{{ $code }}__answer" class="editor"
                                    name="descriptions[{{ $code }}][answer]">
                                        {{ old('descriptions.'.$code.'.answer',($descriptions[$code]['answer']??'')) }}
                                    </textarea>
                                @if ($errors->has('descriptions.'.$code.'.answer'))
                                <span class="form-text">
                                    <i class="fa fa-info-circle"></i> {{ $errors->first('descriptions.'.$code.'.answer') }}
                                </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row kind kind0 kind1 {{ $errors->has('category_id') ? ' text-red' : '' }}">
                            <label for="category_id" class="col-sm-2 col-form-label">
                                {{ trans($pathPlugin.'::Content.admin.select_category') }}
                            </label>
                            <div class="col-sm-8">
                                <select class="form-control input-sm category_id" 
                                    data-placeholder="{{ trans($pathPlugin.'::Content.admin.select_category') }}" style="width: 100%;"
                                    name="category_id">
                                    <option value=""></option>
                        ...
                        <div class="form-group  row {{ $errors->has('alias') ? ' text-red' : '' }}">
                            <label for="alias"
                                class="col-sm-2 col-form-label">{!! trans($pathPlugin.'::Content.alias') !!}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="form-group  row {{ $errors->has('image') ? ' text-red' : '' }}">
                            <label for="image" class="col-sm-2 col-form-label">{{ trans($pathPlugin.'::Content.image') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <a data-input="image" data-preview="preview_image" data-type="faq-image"
                        ...
                        <div class="form-group  row {{ $errors->has('sort') ? ' text-red' : '' }}">
                            <label for="sort" class="col-sm-2 col-form-label">{{ trans($pathPlugin.'::Content.sort') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="form-group  row">
                            <label for="status" class="col-sm-2 col-form-label">{{ trans($pathPlugin.'::Content.status') }}</label>
                            <div class="col-sm-8">
...
<script type="text/javascript">
    ...
    {
        filebrowserImageBrowseUrl: '{{ sc_route_admin('admin.home').'/'.config('lfm.url_prefix') }}?type=faq-image',
        filebrowserImageUploadUrl: '{{ sc_route_admin('admin.home').'/'.config('lfm.url_prefix') }}/upload?type=faq-image&_token={{csrf_token()}}',
